...
@Data
@EnableKafka
@EnableJpaRepositories(basePackages = { "org.jresearch.kafka.aitune.consumer.service","org.jresearch.kafka.aitune.client.service" })
@EntityScan(basePackages = { "org.jresearch.kafka.aitune.client.model" })
public class ConsumerAppConfig extends BaseAppConfig{
